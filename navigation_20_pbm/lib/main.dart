...
// Kelas untuk merepresentasikan data item dengan tambahan description
class Item {
  final int id;
  final String name;
  final String description;  // Tambahan field description

  Item({
    required this.id,
    required this.name,
    required this.description,  // Wajib isi saat instansiasi
  });
}
...
class _MyAppState extends State<MyApp> {
  ...
  // Daftar item contoh dengan description
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'Description: ${item.description}',  // Menampilkan description
