          ...
          switch (settings.name) {
            ...
            case 'connect_device':
              page = ConnectDeviceScreen(
                onSetupComplete: _onConnectComplete,
              );
              break;
            case 'confirm_device':
              page = ConfirmDeviceScreen(
                onFinalComplete: () => _completeSetup(context),
              );
              break;
            default:
              page = FindDevicesScreen(onDeviceFound: _onDeviceFound);
...
// Layar Konfirmasi Perangkat (ConfirmDeviceScreen) - sub-layar baru
class ConfirmDeviceScreen extends StatelessWidget {
  final VoidCallback onFinalComplete;

  const ConfirmDeviceScreen({super.key, required this.onFinalComplete});
